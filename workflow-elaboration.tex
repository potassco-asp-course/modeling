...
\begin{frame}[c]{ASP workflow}
  \begin{center}
    ...
    \begin{picture}(420,200)(-210,-35)
      ...
      \put(   0,-65){\alert<8>{\makebox(0,0){\emph{Elaborating}}}}
      }
    \end{picture}
  \end{center}
\end{frame}
