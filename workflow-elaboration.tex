...
\begin{frame}[c]{ASP solving process}
  \begin{center}
    ...
    \begin{picture}(420,200)(-210,-35)
      ...
      \put(-200,-20){\alert<2,6,7>{\framebox(80,40){\shortstack{\textbf<2>{Logic}\\\textbf<2>{Program}}}}}
      \put(-80,-15){\alert<3,4,6>{\framebox(60,30){\textbf<3>{Grounder}}}}
      \put(  20,-15){\alert<3,4,6>{\framebox(60,30){\textbf<4>{Solver}}}}
      \put( 120,-20){\alert<5,6,7>{\framebox(80,40){\shortstack{\textbf<5>{Stable}\\\textbf<5>{Models}}}}}
      ...
      \put(   0,-65){\alert<7>{\makebox(0,0){\emph{Elaborating}}}}
      }
    \end{picture}
  \end{center}
\end{frame}
