...
\lstinputlisting[basicstyle=\small\ttfamily]{modeling/encodings/cities.lp}
\end{frame}
% ----------------------------------------------------------------------
\begin{frame}[fragile]{Traveling salesperson}{Problem encoding, \texttt{tsp.lp}}
\lstinputlisting[basicstyle=\small\ttfamily]{modeling/encodings/tsp-core.lp}
%
\only<2>{\lstinputlisting[basicstyle=\small\ttfamily,linerange=3]{modeling/encodings/tsp-weak-constraint.lp}}
\only<3>{\lstinputlisting[basicstyle=\small\ttfamily,linerange=3]{modeling/encodings/tsp-minimize.lp}}
\end{frame}
% ----------------------------------------------------------------------
...
\lstinputlisting[basicstyle=\small\ttfamily]{modeling/encodings/tsp-compact.lp}
\end{frame}
% ----------------------------------------------------------------------
%
%%% Local Variables:
