...
\lstinputlisting[basicstyle=\small\ttfamily]{encodings/tspI.lp}
\end{frame}
% ----------------------------------------------------------------------
\begin{frame}[fragile]{Traveling salesperson}{Problem encoding, \texttt{tsp.lp}}
\lstinputlisting[basicstyle=\small\ttfamily]{encodings/tsp.lp}
%
\only<2>{\lstinputlisting[basicstyle=\small\ttfamily]{encodings/tspWC.lp}}
\only<3>{\lstinputlisting[basicstyle=\small\ttfamily]{encodings/tspO.lp}}
\end{frame}
% ----------------------------------------------------------------------
